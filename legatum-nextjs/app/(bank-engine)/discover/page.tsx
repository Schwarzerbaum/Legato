...
const LIVE: Record<string,{t:string;text:string;s:'pos'|'neg'|'neu';ts:string}[]> = {
  phineo:   [
    { t:'◈', text:'PHINEO-Wirkt-Seal spring round 2026 launches', s:'pos', ts:'2h ago' },
    { t:'◎', text:'Handelsblatt: Impact measurement in German NGOs — PHINEO leads', s:'pos', ts:'6h ago' },
    { t:'⊞', text:'Annual report 2025 — transparency ranking A+', s:'pos', ts:'1d ago' },
    { t:'◈', text:'Cooperation agreement with LBBW foundation management signed', s:'pos', ts:'2d ago' },
  ],
  bund:     [
    { t:'◈', text:'BUND BW: Lawsuit filed against Black Forest deforestation', s:'neu', ts:'4h ago' },
    { t:'◎', text:'Federal government cuts conservation funding — BUND criticises sharply', s:'neg', ts:'8h ago' },
    { t:'⊞', text:'DZI donation seal 2025/26 renewed — highest category', s:'pos', ts:'2d ago' },
    { t:'◈', text:'500 new members in BW in May alone', s:'pos', ts:'3d ago' },
  ],
  wwh:      [
    { t:'◎', text:'UN WFP confirms Welthungerhilfe partnership in Ethiopia', s:'pos', ts:'1h ago' },
    { t:'◈', text:'Donation appeal: Horn of Africa drought disaster — target €2M', s:'neu', ts:'5h ago' },
    { t:'⊞', text:'Annual accounts 2025 — 89.4% of funds used for projects', s:'pos', ts:'1d ago' },
  ...
  bws:      [
    { t:'◈', text:'BW Foundation funds 14 new education projects Q2 2026', s:'pos', ts:'3h ago' },
    { t:'◎', text:'State Audit Court: BW Foundation holds full tax exemption notice', s:'pos', ts:'1d ago' },
    { t:'⊞', text:'Foundation Register BW entry confirmed', s:'pos', ts:'2d ago' },
    { t:'◈', text:'New board chair: Dr. Kerstin Müller-Weber from July 2026', s:'neu', ts:'5d ago' },
  ],
  aktion:   [
    { t:'◎', text:'Aktion Mensch: 2026 lottery funds 2,340 projects', s:'pos', ts:'1h ago' },
    { t:'◈', text:'Digital Bridges — Phase 3: 15 new BW locations confirmed', s:'pos', ts:'6h ago' },
    { t:'⊞', text:'Transparency report 2025 — 100% purpose restriction confirmed', s:'pos', ts:'2d ago' },
    { t:'◈', text:'Criticism: lottery fees vs. direct project disbursement', s:'neg', ts:'6d ago' },
  ],
  bosch:    [
    { t:'◈', text:'Bosch Community Fund Q2: 1:1 match extended to Dec 2026', s:'pos', ts:'2h ago' },
    { t:'◎', text:'Bosch CSR Report 2025: €47M in global social investments', s:'pos', ts:'1d ago' },
    { t:'⊞', text:'CSRD Art. 8 Disclosure: Social Taxonomy aligned, Q1 2026', s:'pos', ts:'3d ago' },
    { t:'◈', text:'STEM scholarships BW 2026: application phase now open', s:'pos', ts:'4d ago' },
  ],
  mercedes: [
    { t:'◈', text:'Mercedes 2:1 climate match: 2026 allocation still 40% available', s:'pos', ts:'3h ago' },
    { t:'◎', text:'EU Carbon Neutrality Pledge 2039 — Mercedes two years ahead of schedule', s:'pos', ts:'12h ago' },
    { t:'⊞', text:'SFDR Art. 9 Fund Disclosure aktualisiert Q2 2026', s:'pos', ts:'2d ago' },
    { t:'◈', text:'Stuttgart social projects: €8M funding 2026 announced', s:'pos', ts:'5d ago' },
  ],
  porsche:  [
    ...
    { t:'⊞', text:'1:1 match available: Human Rights Education up to €5k/donor', s:'pos', ts:'4d ago' },
    { t:'◈', text:'Internal compliance review 2025 — no findings', s:'pos', ts:'7d ago' },
  ],
  wuerth:   [
    { t:'◈', text:'Würth Foundation: education matching Q3 2026 now open', s:'pos', ts:'1h ago' },
    { t:'◎', text:'Würth Group: €4.5B revenue Q1 — foundation budget increased', s:'pos', ts:'8h ago' },
    { t:'⊞', text:'SME funding BW: cooperation with IHK Heilbronn', s:'pos', ts:'3d ago' },
